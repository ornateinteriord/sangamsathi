...
>
  <VerifiedUser  sx={{ fontSize: 40,color:'#CE34C2' }} />
...
>
  ...
  >
    <Shield sx={{ fontSize: 50, color:"#CE34C2", mb: 1 }} />
  ...
  >
    <VerifiedUser sx={{ fontSize: 50, color: '#CE34C2', mb: 2 }} />
  ...
  >
    <CreditCard sx={{ fontSize: 50, color:'#CE34C2', mb: 2 }} />
    <Typography variant="h6" sx={{ fontWeight: 500, mb: 1,color:'#000' }}>
      Payment Options
    </Typography>
